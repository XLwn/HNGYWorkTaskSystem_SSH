          ...
          <div class="col-md-12">
            ...
            <div style="height: 1px;" role="main" aria-expanded="false" class="navbar-collapse collapse" id="bs">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="alpha-button-holder"><a class="alpha-button" href="javascript:alert('账号注册请联系管理员添加')">注 册</a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <div style="color:white">目前我们正在为 <font color=red id="teacherNum"></font> 位老师提供了 <font color=red id="workNum"></font> 个任务分发服务,欢迎您的加入。</div>
    ...
    <div class="row">
      <div class="col-sm-12 col-md-12">
        <div class="article-summary">
          <a href="https://blog.digipulse.io/digipulse-foundations-decision-on-token-management-b07f3a150a28" target="_blank">
            <div class="article-img" style="background-image:url(http://p.qlogo.cn/gh/175657290/175657290/)"></div>
          </a>
          <div class="article-title">
            <a href="https://blog.digipulse.io/digipulse-foundations-decision-on-token-management-b07f3a150a28" target="_blank">1 6 级 软 件 协 会 移 软 分 部</a>
          </div>
  ...
  <div class="container">
    <div class="row text-center">
      <div class="col-sm-6 col-sm-offset-3">
        <h3>Fix & Repairs</h3>
        <p>该程序由三个没有网站开发经验的学生开发，或有许多使用上的问题/BUG，如您在使用上有疑惑请联系"网管" <a href="http://wpa.qq.com/msgrd?v=3&uin=1308109287&site=qq&menu=yes" target="_blank">臧胜</a> 或者发邮件给<a href="mailto:1308109287@qq.com">我们</a>.</p>
        <div>
